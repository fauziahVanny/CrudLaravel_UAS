                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        >
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl font-semibold text-black dark:text-white">Kabupaten Purwakarta</h2>
                                        <p class="mt-4 text-sm" style="text-align: justify">
                                            Kabupaten Purwakarta adalah sebuah wilayah kabupaten yang terletak di Provinsi Jawa Barat, Indonesia. Ibu kotanya adalah Kecamatan Purwakarta Kota serta berjarak kurang 
                                            lebih 80 km sebelah tenggara Jakarta dan 44 km sebelah barat laut Bandung. 
                                            Kota ini dikenal sebagai kota pensiun karena suasananya yang tenang dan jauh dari hiruk pikuk kota. Selain itu, Purwakarta juga memiliki julukan kota tasbih dan Purwakarta cantik.

                                            Purwakarta terkenal sebagai tempat kelahiran beberapa negarawan dan pemimpin besar asal Jawa Barat pada awal pendirian Republik Indonesia, di antaranya adalah pahlawan nasional Kusumah Atmaja 
                                            (Ketua pertama Mahkamah Agung Republik Indonesia) dan Ipik Gandamana (Bupati pertama Kabupaten Bogor, Gubernur Jawa Barat, dan Menteri Dalam Negeri).
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="flex items-start  gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Visi Misi</h2>
